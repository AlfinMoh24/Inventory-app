                        ...
                        <div class="row g-2">
                                ...
                                <select class="form-select fs-9" aria-label="Default select example" name="ruang_id">
                                    @foreach ($ruangs as $ruang)
                                        <option value="{{ $ruang->id }}"
                                            {{ old('ruang_id', $dokumen->ruang_id) == $ruang->id ? 'selected' : '' }}>
                                            {{ $ruang->ruang }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-2">
                                ...
                                <select class="form-select fs-9" aria-label="Default select example" name="rak_id">
                                    @foreach ($raks as $rak)
                                        <option value="{{ $rak->id }}"
                                            {{ old('rak_id', $dokumen->rak_id) == $rak->id ? 'selected' : '' }}>
                                            {{ $rak->rak }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-2">
                                ...
                                <select class="form-select fs-9" aria-label="Default select example" name="box_id">
                                    @foreach ($boxs as $box)
                                        <option value="{{ $box->id }}"
                                            {{ old('box_id', $dokumen->box_id) == $box->id ? 'selected' : '' }}>
                                            {{ $box->box }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-2">
                                ...
                                <select class="form-select fs-9" aria-label="Default select example" name="map_id">
                                    @foreach ($maps as $map)
                                        <option value="{{ $map->id }}"
                                            {{ old('map_id', $dokumen->map_id) == $map->id ? 'selected' : '' }}>
                                            {{ $map->map }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select fs-9" aria-label="Default select example" name="urut_id">
                                    @foreach ($uruts as $urut)
                                        <option value="{{ $urut->id }}"
                                            {{ old('urut_id', $dokumen->urut_id) == $urut->id ? 'selected' : '' }}>
                                            {{ $urut->urut }}
                                        </option>
                                    @endforeach
                                </select>
                ...
                <div class="row mb-3 fs-9">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="no_dok" name="no_dok"
                            value="{{ old('no_dok', $dokumen->no_dok) }}">
                    </div>
                </div>
                <div class="row mb-3 fs-9">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="kode_dok" name="kode_dok"
                            value="{{ old('kode_dok', $dokumen->kode_dok) }}">
                    </div>
                </div>
                <div class="row mb-3 fs-9">
                ...
                <div class="row mb-3 fs-9">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="deskripsi" name="deskripsi"
                            value="{{ old('deskripsi', $dokumen->deskripsi) }}">
                    </div>
                </div>
                <div class="row mb-3 fs-9">
